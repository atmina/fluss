...
public class Snapshot
{
    ...
    private static readonly ImmutableStack<ISnapshotValueFormatter> Formatters =
        ImmutableStack.CreateRange(new ISnapshotValueFormatter[]
        {
    ...
    private static readonly JsonSnapshotValueFormatter DefaultFormatter = new();
    ...
    public void Match()
    {
        ...
        else
        {
            ...
            var after = Encoding.GetString(writer.WrittenSpan);
